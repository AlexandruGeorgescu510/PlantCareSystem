...
config = {
  "apiKey": "zyleRBLyGmnMpO81r40zUvbIVT9W69Yk3Qv3mqD5",
  "authDomain": "database-71ddd.firebaseapp.com",
  "databaseURL": "https://database-71ddd-default-rtdb.europe-west1.firebasedatabase.app/device1",
  "storageBucket": "database-71ddd.appspot.com"
}
...
def boostLight():
 ...
 if now.hour>5 and now.hour<21:
     ...
     else: GPIO.output(LIGHTBOOST_PIN,GPIO.LOW)
 else: GPIO.output(LIGHTBOOST_PIN,GPIO.LOW)
